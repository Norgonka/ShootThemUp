...
void  USTUWeaponComponent::InitAnimations()
{
	...
	{
		UE_LOG(LogWeaponComponent, Error, TEXT("EquipAnimNotify has been forgotten to set"));
		checkNoEntry();
	}
	for (auto OneWeaponData : WeaponData)
	{
		...
		{
			UE_LOG(LogWeaponComponent, Error, TEXT("ReloadAnimNotify has been forgotten to set"));
			checkNoEntry();
		}
...
bool  USTUWeaponComponent::TryToAddAmmo(TSubclassOf<ASTUBaseWeapon> WeaponType, int32 Clips)
{
	for (const auto Weapon : Weapons)
	{
